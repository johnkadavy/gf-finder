  ...
  return (
    <main className="pt-16">
      ...
      >
        <div className="max-w-3xl mx-auto">
          ...
          >
            Less guesswork.
            <br />
            <span style={{ color: "var(--accent)" }}>More confidence.</span>
          </h1>
        </div>
      </section>
      ...
      <article className="max-w-3xl mx-auto px-8 py-16 md:py-24">
        <div className="space-y-8 text-ui-body leading-[1.85] text-text-secondary">
          <p>
          ...
          <p className="text-text-tertiary">
            <strong className="text-text-primary font-medium">CleanPlate is a guide, not a guarantee.</strong> Kitchen environments can change, and no
