...
export function SharedMapView({ restaurants, isLoggedIn }: { restaurants: SharedRestaurant[]; isLoggedIn: boolean }) {
  ...
  return (
    <div className="fixed inset-0 pt-16 z-0">
      ...
      {selected && (
        <div
          className="absolute top-12 left-3 w-72 md:w-80 pointer-events-auto"
          style={{ zIndex: 10 }}
        >
          <div
          ...
          >
            <button
              ...
              className="absolute top-3 right-3 font-mono text-[12px] leading-none transition-colors"
              style={{ color: "oklch(0.4 0 0)" }}
            >
              ✕
            </button>
            <div className="flex items-start justify-between gap-3 pr-4">
              <div className="min-w-0">
                <Link
                  ...
                  style={{ fontSize: "1.25rem", color: "oklch(0.95 0 0)", letterSpacing: "0.02em" }}
                >
                  {selected.name}
                </Link>
            ...
            <div className="flex items-center gap-4 pt-1">
              ...
              {selected.website && (
                <a
                  ...
                  className="font-mono text-[10px] uppercase tracking-[0.15em] hover:text-[#FF7444] transition-colors"
                  style={{ color: "oklch(0.55 0 0)" }}
                >
                  Website ↗
                </a>
